...
# Test Run 300 (Decay SOM1surf = 1.34, SOM1soil = 2, SOM2 = 0.4, Deadwood and roots * 0.001, NSlope = 0.01, DeNitrif = 0.05, NIntercept = 0.25)
# SOM1surfN * 0.1, SOM2N * 0.25, SOM1soilN * 0.1
# Drainage * 0.1

```{r}
successionLog <- read_csv("C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 2/LANDIS Outputs/Small Landscape/Test300/NECN-succession-log.csv")
...
ggplot(nitrogenDf, aes(x = Time, y = g_m2, col = Pool)) +
  ...
  annotate("text", x = 27, y = Inf, label = "DecaySurf = 1.34\nDecaySoil = 2\nDecaySOM2 = 0.4\nDecaySOM3 = 0.0000001\nDenitrification = 0.05\nNSlope = 0.01\nNIntercept = 0.25", 
           ...
           fontface = "bold", family = "serif") +
  theme(plot.margin = margin(10, 40, 10, 10)) +
  scale_x_continuous(breaks = seq(0, 100, 10), limits = c(0,300)) +
  scale_color_manual(values = c("TotalSoilN" = "red", "N_SOM1surf" = "cornflowerblue", "N_SOM1soil" = "darkorchid", "N_SOM2" = "darkorange", "N_SOM3" = "darkgreen"))
...
ggplot(ratioDf, aes(x = Time, y = `C:N Ratio`, col = Pool)) +
  ...
  theme(plot.margin = margin(10, 40, 10, 10)) +
  scale_x_continuous(breaks = seq(0, 300, 10), limits = c(0,300)) +
  geom_vline(xintercept = 200, linetype = "solid", col = "black") +
  geom_hline(yintercept = 40, linetype = "dashed") + # SOM2
  geom_hline(yintercept = 58, linetype = "dashed") + # Surf
  geom_hline(yintercept = 8, linetype = "dashed") + # SOM3
  geom_hline(yintercept = 10, linetype = "dashed") + # Soil
  scale_color_manual(values = c("Total" = "red", "Surf" = "cornflowerblue", "Soil" = "darkorchid", "SOM2" = "darkorange", "SOM3" = "darkgreen")) +
  ylim(0,70)
```

# NEW SOIL RASTER RATIOS: SEE SOIL TESTING.RMD FOR THE CODE
# Test Run 21 (Decay SOM1surf = 1.34, SOM1soil = 2, SOM2 = 0.4, Deadwood and roots * 0.001, NSlope = 0.01, DeNitrif = 0.05, NIntercept = 0.25)
# Drainage * 0.1

```{r}
successionLog <- read_csv("C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 2/LANDIS Outputs/Small Landscape/Test 21/NECN-succession-log.csv")
...
ggplot(ratioDf, aes(x = Time, y = `C:N Ratio`, col = Pool)) +
  ...
  theme(plot.margin = margin(10, 40, 10, 10)) +
  scale_x_continuous(breaks = seq(0, 100, 10), limits = c(0,100)) +
  geom_hline(yintercept = 60, linetype = "dashed") + # SOM1surf
  geom_hline(yintercept = 10, linetype = "dashed") + # SOM1soil
  geom_hline(yintercept = 44, linetype = "dashed") + # SOM2
  geom_hline(yintercept = 7, linetype = "dashed") + # SOM3
  scale_color_manual(values = c("Total" = "red", "Surf" = "cornflowerblue", "Soil" = "darkorchid", "SOM2" = "darkorange", "SOM3" = "darkgreen"))
```

# NEW SOIL RASTER RATIOS: SEE SOIL TESTING.RMD FOR THE CODE (SET B)
# Test Run 22 (Decay SOM1surf = 1.34, SOM1soil = 2, SOM2 = 0.4, Deadwood and roots * 0.001, NSlope = 0.01, DeNitrif = 0.05, NIntercept = 0.25)
# Drainage * 0.1

```{r}
successionLog <- read_csv("C:/Users/lagoodal/Desktop/Dissertation Stuff/Chapter 2/LANDIS Outputs/Small Landscape/Test 22/NECN-succession-log.csv")
...
test <- read_csv("C:/Users/lagoodal/Desktop/Dissertation Stuff/Clipped Test/Small Landscape/Final_table.csv")
